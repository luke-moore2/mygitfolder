...
class Game(Frame):
    ...
    def createRooms(self):
                ...
                r5 = Room("Kitchen","room4.gif")
                r6 = Room("Room 6","room4.gif")
                basement=Room("Basement: Once you enter doors Get locked","room4.gif")
                bathroom=Room("Bathroom","room4.gif")
                attic=Room("Attic","room4.gif")
